...
// pub struct Network {
//     //// Persistant data
//     pub graph: Graph<ForayNode, PortType, PortData>,
//     //// Runtime data
//     #[serde(skip)]
...
//                     let foray_node = &mut network.graph.get_mut_node(nx);
//                     if let ForayNode::PyNode(py_node) = foray_node {
